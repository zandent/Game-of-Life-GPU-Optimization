...
// 8: add pinned mem, based on 5
// 9: insert top/bot rows to input, based on 8 //FASTEST
// 10: add stream pipeline based on 8 
// 11: share mem replace inboard based on 10
// 12: share mem creates LUT to replace LUT based on 10 OR directly move const content to sharemem to replace. Both slow!
// 13: add marek fiser's implementation
...
char* game_of_life_gpu (char* outboard, char* inboard, const int nrows, const int ncols, const int gens_max){
  ...
  cudaMallocHost((void**)&parsed_inboard, bytes);
  cudaMallocHost((void**)&parsed_outboard, bytes);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////// LOOKUP TABLE 2 BIT COMPACT CONST MEM IMPLEMENTATION with PINNED MEMORY  ///////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
